 ...
 *
 * CANONICAL COPY: stage5-api/src/shared/wire-protocol.ts   <- this file
 * Copies:         translator/packages/shared/constants/wire-protocol.ts
...
export const WIRE_TOO_MANY_ACTIVE_TRANSLATIONS =
  "too-many-active-translations";
export const WIRE_TRANSLATION_RATE_LIMIT = "translation-rate-limit";
export const WIRE_TRANSLATION_QUEUE_OVERLOADED =
  "translation-queue-overloaded";
